...
def on_connect(client, userdata, flags, rc):
  ...
  client.subscribe("tele/tasmota_0AFAE2/SENSOR")
...
#  print(msg.topic + " " + str(msg.payload))
  ...
  try:
    ...
    data1 = json_data['AM2301']
    data2 = data1['Temperature']
    data3 = data1['Humidity']
    print('[MQTT] Message received from topic \"' + msg.topic + '\": ' + str(data2) + ' - ' + str(data3))

    conversionTopic = "home/leavingroom/temperature"
    client.publish(conversionTopic, data2)
    print('[MQTT] Message sent to topic \"' + conversionTopic + '\": ' + str(data2) )
    conversionTopic = "home/leavingroom/humidity"
    client.publish(conversionTopic, data3)
